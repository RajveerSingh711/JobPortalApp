      ...
      <div className="my-4">
        ...
        <h1 className="font-bold my-1">
          ...
          <span className="pl-4 font-normal text-gray-800">
            ...
            cum minus voluptatum quos possimus dignissimos, eius tempora quas
            harum maiores odio aliquam suscipit in minima sint reiciendis nobis
            hic totam.
          </span>
        </h1>
        <h1 className="font-bold my-1">
        ...
        <h1 className="font-bold my-1">
          Posted Date:{" "}
          <span className="pl-4 font-normal text-gray-800">06-08-2025</span>
        </h1>
      </div>
    </div>
  );
